...
class DialogCategory extends StatelessWidget {
  ...
  DialogCategory(this._bloc, this._user, this._category);

  @override
  Widget build(BuildContext context) {
    if (_category != null) myController.text = _category.name;
        ...
        children: <Widget>[
          Container(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  ...
                  labelText: StringConstant.nameCategory,
                  hintText: StringConstant.nameCategory,
                ),
                style: TextStyle(
                  fontSize: 24.0,
          ...
          Row(
            ...
            children: [
              ...
              FlatButton(
                onPressed: () {
                  _user.categories.add(
                      new Category(myController.text, _user.categories.length));
                  _bloc.setUser(_user);
                  Navigator.of(context).pop(); // To close the dialog
                },
